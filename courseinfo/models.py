...
class Semester(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('courseinfo_semester_detailed_urlpattern',
                       kwargs={'pk': self.pk}
                       )
...
class Course(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('courseinfo_course_detailed_urlpattern',
                       kwargs={'pk': self.pk}
                       )
...
class Instructor(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('courseinfo_instructor_detailed_urlpattern',
                       kwargs={'pk': self.pk}
                       )
...
class Student(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('courseinfo_student_detailed_urlpattern',
                       kwargs={'pk': self.pk}
                       )
...
class Section(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('courseinfo_section_detailed_urlpattern',
                       kwargs={'pk': self.pk}
                       )
...
class Registration(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('courseinfo_registration_detailed_urlpattern',
                       kwargs={'pk': self.pk}
                       )
