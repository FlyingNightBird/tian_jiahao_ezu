...
from courseinfo.views import (
    ...
    SectionDetail, SemesterDetail, StudentDetail, CourseDetail, RegistrationDetail, InstructorCreate, SectionCreate,
    CourseCreate, SemesterCreate, StudentCreate, RegistrationCreate, InstructorUpdate, SectionUpdate, CourseUpdate,
    SemesterUpdate, StudentUpdate, RegistrationUpdate, RegistrationDelete, InstructorDelete, SectionDelete,
    SemesterDelete, CourseDelete, StudentDelete,
)
...
urlpatterns = [
    ...
    path('instructor/<int:pk>/',
         ...
         name='courseinfo_instructor_detailed_urlpattern'),
    ...
    path('section/<int:pk>/',
         ...
         name='courseinfo_section_detailed_urlpattern'),
    ...
    path('course/<int:pk>/',
         ...
         name='courseinfo_course_detailed_urlpattern'),
    ...
    path('semester/<int:pk>/',
         ...
         name='courseinfo_semester_detailed_urlpattern'),
    ...
    path('student/<int:pk>/',
         ...
         name='courseinfo_student_detailed_urlpattern'),
    ...
    path('registration/<int:pk>/',
         ...
         name='courseinfo_registration_detailed_urlpattern'),
